...
require (
	...
	github.com/openziti/ziti v0.27.2
...
require (
	...
	github.com/openziti/channel/v2 v2.0.25 // indirect
	github.com/openziti/foundation/v2 v2.0.10 // indirect
	github.com/openziti/identity v1.0.29 // indirect
	github.com/openziti/metrics v1.2.3 // indirect
	github.com/openziti/transport/v2 v2.0.49 // indirect
